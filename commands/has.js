...
exports.run = async (client, message, cmd, args, level) => { // eslint-disable-line no-unused-vars
    ...
    const hasMessage = await message.channel.send("Checking... One moment. :eyes:");
    ...
    let embed = new RichEmbed() // eslint-disable-line prefer-const
        .setTitle(`Character Check For ${id}:`)
        .setColor(0xEE7100)
    ...
    client.log("log", `Adding field: ${description}`, `${title}`);
